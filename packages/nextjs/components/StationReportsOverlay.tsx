...
export default function StationReportsOverlay({ stationId, stationName, onClose, onSubmitReport }: Props) {
  ...
  const { loading, error, safetyScore, latestReport, last7DaysReports, allTimeReports, stationAddress } =
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-gray-900 rounded-lg shadow-2xl w-full max-w-2xl max-h-[80vh] flex flex-col border border-gray-700">
        ...
        <div className="flex border-b border-gray-700">
          <button
            ...
            className={`flex-1 py-3 px-4 font-semibold ${
              activeTab === "latest" ? "bg-blue-600 text-white" : "bg-gray-800 text-gray-400 hover:text-white"
            }`}
          >
            Latest
          </button>
          <button
            ...
            className={`flex-1 py-3 px-4 font-semibold ${
              activeTab === "last7days" ? "bg-blue-600 text-white" : "bg-gray-800 text-gray-400 hover:text-white"
            }`}
          >
          ...
          <button
            ...
            className={`flex-1 py-3 px-4 font-semibold ${
              activeTab === "alltime" ? "bg-blue-600 text-white" : "bg-gray-800 text-gray-400 hover:text-white"
            }`}
          >
        ...
        <div className="p-6 overflow-y-auto flex-1">
          {loading && <div className="text-center text-gray-400 py-8">Loading reports...</div>}
          ...
          {!loading && !error && activeReports.length > 0 && (
            <div className="space-y-4">
              {activeReports.map(report => (
                <div key={report.cid} className="bg-gray-800 p-4 rounded-lg border border-gray-700">
