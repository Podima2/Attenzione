...
// 👈 Needed for Vector3 in CameraController
import dynamic from "next/dynamic";
import { MetroStop, metroStops } from "../../data/metroData";
...
// 👈 Import metroStops for CameraController logic
  ...
  return (
    <div style={{ width: "100vw", height: "100vh", position: "relative" }}>
      ...
      <Canvas camera={{ position: [0, 1000, 0], fov: 60, near: 0.1, far: 5000 }}>
        ...
        <OrbitControls enableDamping dampingFactor={0.1} zoomSpeed={1.2} rotateSpeed={0.7} target={[0, 0, 0]} />
